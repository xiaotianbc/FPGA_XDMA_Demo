...
-- Date        : Mon May 29 20:46:57 2023
-- Host        : DESKTOP-IM8BV9E running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/xiaotian/Desktop/PCIE_EXP/DIY_MEMBLAZE_PCIE/DIY_MEMBLAZE_PCIE_learn_ALINX/DIY_MEMBLAZE_PCIE_learn_ALINX.srcs/sources_1/bd/PCIE_XDMA/ip/PCIE_XDMA_util_ds_buf_0_0/PCIE_XDMA_util_ds_buf_0_0_sim_netlist.vhdl
-- Design      : PCIE_XDMA_util_ds_buf_0_0
...
entity PCIE_XDMA_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of PCIE_XDMA_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of PCIE_XDMA_util_ds_buf_0_0_util_ds_buf : entity is "ibufdsgte2";
  attribute C_SIZE : integer;
  attribute C_SIZE of PCIE_XDMA_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of PCIE_XDMA_util_ds_buf_0_0_util_ds_buf : entity is "util_ds_buf";
end PCIE_XDMA_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of PCIE_XDMA_util_ds_buf_0_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity PCIE_XDMA_util_ds_buf_0_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of PCIE_XDMA_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of PCIE_XDMA_util_ds_buf_0_0 : entity is "PCIE_XDMA_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of PCIE_XDMA_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of PCIE_XDMA_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2019.1";
end PCIE_XDMA_util_ds_buf_0_0;

architecture STRUCTURE of PCIE_XDMA_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN PCIE_XDMA_util_ds_buf_0_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN PCIE_XDMA_util_ds_buf_0_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.PCIE_XDMA_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
