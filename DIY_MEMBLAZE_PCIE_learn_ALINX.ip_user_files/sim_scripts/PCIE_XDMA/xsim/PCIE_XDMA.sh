...
xv_boost_lib_path=D:/Bigboy/vv2019_1/Vivado/2019.1/tps/boost_1_64_0
xvlog_opts="--relax"
xvhdl_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L blk_mem_gen_v8_4_3 -L fifo_generator_v13_1_4 -L xdma_v4_1_3 -L xlconstant_v1_1_6 -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_4 -L axi_clock_converter_v2_1_18 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PCIE_XDMA xil_defaultlib.PCIE_XDMA xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PCIE_XDMA -key {Behavioral:sim_1:Functional:PCIE_XDMA} -tclbatch cmd.tcl -protoinst "protoinst_files/PCIE_XDMA.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Bigboy/vv2019_1/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PCIE_XDMA.wdb xsim.dir)
